...
class DLLIMPORT LaSpdTridiagMatDouble
{
    int size_;
...
public:
    ...
    friend DLLIMPORT std::ostream& operator<<(std::ostream&, const LaSpdTridiagMatDouble&);


};

DLLIMPORT std::ostream& operator<<(std::ostream& s, const LaSpdTridiagMatDouble& td);
