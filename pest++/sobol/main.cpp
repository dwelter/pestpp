...
int main(int argc, char* argv[])
{
	...
	if (argc >=2) {
		...
		cerr << endl<< "Sobol++ Version " << version << endl << endl;
		cerr << "Usage: sobol pest_ctl_file" << endl << endl;
		exit(1);
	}
	...
	cout << "Sobol Version " << version << endl << endl;
	fout_rec << "Sobol Version " << version << endl << endl;
	...
	//Build Transformation with ctl_2_numeric
