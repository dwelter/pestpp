...
public:
	...
	virtual LaVectorDouble get_residuals_vec(const vector<string> &obs_names) = 0;
...
public:
	...
	const ModelRun& operator=(const ModelRun &rhs);
	...
	virtual LaVectorDouble get_residuals_vec(const vector<string> &obs_names);
