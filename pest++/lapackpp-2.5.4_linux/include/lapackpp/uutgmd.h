...
class DLLIMPORT LaUnitUpperTriangMatDouble
{
...
public:
    ...
    friend DLLIMPORT std::ostream &operator<<(std::ostream &, const LaUnitUpperTriangMatDouble &);
...
DLLIMPORT std::ostream &operator<<(std::ostream &s, const LaUnitUpperTriangMatDouble &ob);
