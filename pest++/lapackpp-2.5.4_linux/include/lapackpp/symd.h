...
class DLLIMPORT LaSymmMatDouble
{
...
inline const double& LaSymmMatDouble::operator()(int i, int j) const
{
...
inline LaSymmMatDouble& LaSymmMatDouble::resize(int m, int n)
{
    lower_data_.resize(m, n);
