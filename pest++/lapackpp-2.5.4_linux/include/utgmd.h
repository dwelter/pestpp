...
class DLLIMPORT LaUpperTriangMatDouble
{
...
public:
    ...
    friend DLLIMPORT std::ostream &operator<<(std::ostream &, const LaUpperTriangMatDouble &);
...
DLLIMPORT std::ostream &operator<<(std::ostream &s, const LaUpperTriangMatDouble &ob);
...
inline const double& LaUpperTriangMatDouble::operator()(int i, int j) const
{
