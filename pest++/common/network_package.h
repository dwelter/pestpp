...
{
public:
	enum class PackType{UNKN, OK, CONFIRM_OK, READY, REQ_RUNDIR, RUNDIR, REQ_LINPACK, LINPACK, CMD, START_RUN, RUN_FINISH, RUN_FAILED, TERMINATE,PING,REQ_KILL,IO_ERROR};
