...
using namespace std;
 ...
 #ifdef OS_LINUX
 #define DEF_MODEL_INPUT_OUTPUT_INTERFACE_mp_MIO_INITIALISE MODEL_INPUT_OUTPUT_INTERFACE_mp_MIO_INITIALISE_
 #define DEF_MODEL_INPUT_OUTPUT_INTERFACE_mp_MIO_PUT_FILE MODEL_INPUT_OUTPUT_INTERFACE_mp_MIO_PUT_FILE_
 #define DEF_MODEL_INPUT_OUTPUT_INTERFACE_mp_MIO_GET_FILE MODEL_INPUT_OUTPUT_INTERFACE_mp_MIO_GET_FILE_
 #define DEF_MODEL_INPUT_OUTPUT_INTERFACE_mp_MIO_STORE_INSTRUCTION_SET MODEL_INPUT_OUTPUT_INTERFACE_mp_MIO_STORE_INSTRUCTION_SET_
 #define DEF_MODEL_INPUT_OUTPUT_INTERFACE_mp_MIO_PROCESS_TEMPLATE_FILES MODEL_INPUT_OUTPUT_INTERFACE_mp_MIO_PROCESS_TEMPLATE_FILES_
 #define DEF_MODEL_INPUT_OUTPUT_INTERFACE_mp_MIO_DELETE_OUTPUT_FILES MODEL_INPUT_OUTPUT_INTERFACE_mp_MIO_DELETE_OUTPUT_FILES_
 #define DEF_MODEL_INPUT_OUTPUT_INTERFACE_mp_MIO_WRITE_MODEL_INPUT_FILES MODEL_INPUT_OUTPUT_INTERFACE_mp_MIO_WRITE_MODEL_INPUT_FILES_
 #define DEF_MODEL_INPUT_OUTPUT_INTERFACE_mp_MIO_READ_MODEL_OUTPUT_FILES MODEL_INPUT_OUTPUT_INTERFACE_mp_MIO_READ_MODEL_OUTPUT_FILES_
 #define DEF_MODEL_INPUT_OUTPUT_INTERFACE_mp_MIO_FINALISE MODEL_INPUT_OUTPUT_INTERFACE_mp_MIO_FINALISE_
 #define DEF_MODEL_INPUT_OUTPUT_INTERFACE_mp_MIO_GET_STATUS MODEL_INPUT_OUTPUT_INTERFACE_mp_MIO_GET_STATUS_
 #define DEF_MODEL_INPUT_OUTPUT_INTERFACE_mp_MIO_GET_DIMENSIONS MODEL_INPUT_OUTPUT_INTERFACE_mp_MIO_GET_DIMENSIONS_
 #define DEF_MODEL_INPUT_OUTPUT_INTERFACE_mp_MIO_GET_MESSAGE_STRING MODEL_INPUT_OUTPUT_INTERFACE_mp_MIO_GET_MESSAGE_STRING_
 #endif
