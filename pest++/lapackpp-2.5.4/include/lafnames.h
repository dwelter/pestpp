...
/** @file
 * @brief Define macros for header file names
*/
...
#define LA_GEN_QR_FACT_COMPLEX_H           "gfqrc.h"
#define LA_GEN_QR_FACT_DOUBLE_H            "gfqrd.h"
#define LA_INDEX_H                         "laindex.h"
#define LA_PREFS_H                         "laprefs.h"
...
#define LA_TEMPLATES_H                     "latmpl.h"
