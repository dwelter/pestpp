...
DLLIMPORT double LaUpperTriangMatDouble::outofbounds_ = 0; // initialize outobounds

DLLIMPORT int LaUpperTriangMatDouble::debug_ = 0;  // turn off global debug
// use A.debug(1) to turn on/off
// and A.debug() to check current status.

DLLIMPORT int* LaUpperTriangMatDouble::info_ = new int; // turn off info print flag.
