...
DLLIMPORT double LaUnitLowerTriangMatDouble::outofbounds_ = 0; // set outofbounds_.

DLLIMPORT int LaUnitLowerTriangMatDouble::debug_ = 0; // set debug to 0 initially.

DLLIMPORT int* LaUnitLowerTriangMatDouble::info_ = new int; // turn off info print flag.
